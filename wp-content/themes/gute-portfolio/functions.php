...
function gute_portfolio_enqueue_child_styles() {
   ...
   wp_enqueue_style( 'gute-portfolio-main',get_stylesheet_directory_uri() . '/assets/css/main.css', array(),'1.0.7','all');
 ...
 * Recomended plugin 
 */
require get_stylesheet_directory() . '/inc/tgm-plugin.php';
