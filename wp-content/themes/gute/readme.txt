...
* Screenshot image header image: CC0 by free photos via pxhere (https://pxhere.com/en/photo/1087294)
...
== Changelog ==
= 1.2.4 =
* Full width template edited
* Added style for blog
* Added new customize options
= 1.2.3 =
* Remove default image for list blog
* Added footer copyright text
= 1.2.1 =
* Added New template
* Added New responsive class
...
= 1.1.0 =
* Add: Header image settings change
* Add: Header settings now show default
= 1.0.6 =
* Add: new css for style
= 1.0.4 =
* Add: New option for header text
* Fixed: Fixed some php code
