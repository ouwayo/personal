...
function gute_scripts() {
	...
	wp_enqueue_style( 'gute-default', get_template_directory_uri().'/assets/css/default.css',array(),'1.2.5','all' );
	wp_enqueue_style( 'gute-style', get_stylesheet_uri(),array(),'1.2.2','all' );
 ...
 * Extra Hook
 */
require get_template_directory() . '/inc/extra-hook.php';
/**
 * Customizer additions.
 */
