...
<?php } else { ?>
 <div class="company-social"><a href="#"><?php esc_html_e('UP','portfoliolite'); ?></a>
 <?php } ?>   
    </div>
...
<?php } else { ?>
  <p class="footer-copyright">&copy;
              ...
              echo date_i18n(
                ...
                _x( 'Y', 'copyright date format', 'Scroll' )
              );
              ?>
              <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo( 'name' ); ?></a>
            <span class="powered-by-wordpress">
              <span><?php _e( '', 'scroll' ); ?></span>
              <a href="<?php echo esc_url( __( 'www.linkedin.com/in/oscar-uwayo', 'Oscar Uwayo' ) ); ?>">
                <?php _e( '', '' ); ?>
              </a>
            </span>
  </p><!-- .footer-copyright -->
